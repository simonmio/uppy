...
(function (global){
function debounce(t,e,n){function r(e){var n=s,r=v;return s=v=void 0,g=e,y=t.apply(r,n)}function o(t){return g=t,j=setTimeout(u,e),p?r(t):y}function i(t){var n=t-d,r=t-g,o=e-n;return O?nativeMin(o,m-r):o}function a(t){var n=t-d,r=t-g;return void 0===d||n>=e||n<0||O&&r>=m}function u(){var t=now();return a(t)?f(t):void(j=setTimeout(u,i(t)))}function f(t){return j=void 0,T&&s?r(t):(s=v=void 0,y)}function c(){void 0!==j&&clearTimeout(j),g=0,s=d=v=j=void 0}function l(){return void 0===j?y:f(now())}function b(){var t=now(),n=a(t);if(s=arguments,v=this,d=t,n){if(void 0===j)return o(d);if(O)return j=setTimeout(u,e),r(d)}return void 0===j&&(j=setTimeout(u,e)),y}var s,v,m,y,j,d,g=0,p=!1,O=!1,T=!0;if("function"!=typeof t)throw new TypeError(FUNC_ERROR_TEXT);return e=toNumber(e)||0,isObject(n)&&(p=!!n.leading,O="maxWait"in n,m=O?nativeMax(toNumber(n.maxWait)||0,e):m,T="trailing"in n?!!n.trailing:T),b.cancel=c,b.flush=l,b}function throttle(t,e,n){var r=!0,o=!0;if("function"!=typeof t)throw new TypeError(FUNC_ERROR_TEXT);return isObject(n)&&(r="leading"in n?!!n.leading:r,o="trailing"in n?!!n.trailing:o),debounce(t,e,{leading:r,maxWait:e,trailing:o})}function isObject(t){var e=typeof t;return!!t&&("object"==e||"function"==e)}function isObjectLike(t){return!!t&&"object"==typeof t}function isSymbol(t){return"symbol"==typeof t||isObjectLike(t)&&objectToString.call(t)==symbolTag}function toNumber(t){if("number"==typeof t)return t;if(isSymbol(t))return NAN;if(isObject(t)){var e="function"==typeof t.valueOf?t.valueOf():t;t=isObject(e)?e+"":e}if("string"!=typeof t)return 0===t?t:+t;t=t.replace(reTrim,"");var n=reIsBinary.test(t);return n||reIsOctal.test(t)?freeParseInt(t.slice(2),n?2:8):reIsBadHex.test(t)?NAN:+t}var FUNC_ERROR_TEXT="Expected a function",NAN=NaN,symbolTag="[object Symbol]",reTrim=/^\s+|\s+$/g,reIsBadHex=/^[-+]0x[0-9a-f]+$/i,reIsBinary=/^0b[01]+$/i,reIsOctal=/^0o[0-7]+$/i,freeParseInt=parseInt,freeGlobal="object"==typeof global&&global&&global.Object===Object&&global,freeSelf="object"==typeof self&&self&&self.Object===Object&&self,root=freeGlobal||freeSelf||Function("return this")(),objectProto=Object.prototype,objectToString=objectProto.toString,nativeMax=Math.max,nativeMin=Math.min,now=function(){return root.Date.now()};module.exports=throttle;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
"use strict";function _classCallCheck(t,r){if(!(t instanceof r))throw new TypeError("Cannot call a class as a function")}var _extends=Object.assign||function(t){for(var r=1;r<arguments.length;r++){var e=arguments[r];for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n])}return t};module.exports=function(){function t(r){_classCallCheck(this,t);var e={locale:{strings:{},pluralize:function(t){return 1===t?0:1}}};this.opts=_extends({},e,r),this.locale=_extends({},e.locale,r.locale)}return t.prototype.interpolate=function(t,r){var e=String.prototype.replace,n=/\$/g,a="$$$$";for(var o in r)if("_"!==o&&r.hasOwnProperty(o)){var l=r[o];"string"==typeof l&&(l=e.call(r[o],n,a)),t=e.call(t,new RegExp("%\\{"+o+"\\}","g"),l)}return t},t.prototype.translate=function(t,r){if(r&&r.smart_count){var e=this.locale.pluralize(r.smart_count);return this.interpolate(this.opts.locale.strings[t][e],r)}return this.interpolate(this.opts.locale.strings[t],r)},t}();
...
"use strict";var _appendChild=require("yo-yoify/lib/appendChild");module.exports=function(e){var t,n,a,i,r,l,u=e.demo?(t=document.createElement("button"),t.onclick=e.handleDemoAuth,t.setAttribute("class","UppyProvider-authBtnDemo"),t.textContent="Proceed with Demo Account",t):null;return l=document.createElement("div"),l.setAttribute("class","UppyProvider-auth"),_appendChild(l,[" ",(i=document.createElement("h1"),i.setAttribute("class","UppyProvider-authTitle"),_appendChild(i,[" Please authenticate with ",(n=document.createElement("span"),n.setAttribute("class","UppyProvider-authTitleName"),_appendChild(n,[e.pluginName]),n),a=document.createElement("br")," to select files "]),i)," ",(r=document.createElement("button"),r.onclick=e.handleAuth,r.setAttribute("class","UppyProvider-authBtn"),r.textContent="Authenticate",r)," ",u," "]),l};
...
"use strict";var _appendChild=require("yo-yoify/lib/appendChild"),getFileTypeIcon=require("./getFileTypeIcon"),_require=require("./icons"),checkIcon=_require.checkIcon;module.exports=function(e){function t(e){var t=e.target.value,i=e.target.attributes.name.value;F[i]=t}function i(i){var a=e.metaFields||[];return a.map(function(e){var a,r,n;return n=document.createElement("fieldset"),n.setAttribute("class","UppyDashboardFileCard-fieldset"),_appendChild(n,[" ",(a=document.createElement("label"),a.setAttribute("class","UppyDashboardFileCard-label"),_appendChild(a,[e.name]),a)," ",(r=document.createElement("input"),r.setAttribute("name",""+String(e.id)),r.setAttribute("type","text"),r.setAttribute("value",""+String(i.meta[e.id])),r.setAttribute("placeholder",""+String(e.placeholder||"")),r.onkeyup=t,r.setAttribute("class","UppyDashboardFileCard-input"),r)]),n})}var a,r,n,l,d,s,p,c,o,u,b,m,h,y,C,A=!!e.fileCardFor&&e.files[e.fileCardFor],F={};return p=document.createElement("div"),p.setAttribute("aria-hidden",""+String(!e.fileCardFor)),p.setAttribute("class","UppyDashboardFileCard"),_appendChild(p,[" ",(l=document.createElement("div"),l.setAttribute("class","UppyDashboardContent-bar"),_appendChild(l,[" ",(r=document.createElement("h2"),r.setAttribute("class","UppyDashboardContent-title"),_appendChild(r,["Editing ",(a=document.createElement("span"),a.setAttribute("class","UppyDashboardContent-titleFile"),_appendChild(a,[A.meta?A.meta.name:A.name]),a)]),r)," ",(n=document.createElement("button"),n.setAttribute("title","Finish editing file"),n.onclick=function(){return e.done(F,A.id)},n.setAttribute("class","UppyDashboardContent-back"),n.textContent="Done",n)," "]),l)," ",e.fileCardFor?(h=document.createElement("div"),h.setAttribute("class","UppyDashboardFileCard-inner"),_appendChild(h,[" ",(c=document.createElement("div"),c.setAttribute("class","UppyDashboardFileCard-preview"),_appendChild(c,[" ",A.preview?(y=document.createElement("img"),y.setAttribute("alt",""+String(A.name)),y.setAttribute("src",""+String(A.preview)),y):(C=document.createElement("div"),C.setAttribute("style","color: "+String(getFileTypeIcon(A.type.general,A.type.specific).color)),C.setAttribute("class","UppyDashboardItem-previewIcon"),_appendChild(C,[" ",getFileTypeIcon(A.type.general,A.type.specific).icon," "]),C)," "]),c)," ",(m=document.createElement("div"),m.setAttribute("class","UppyDashboardFileCard-info"),_appendChild(m,[" ",(b=document.createElement("fieldset"),b.setAttribute("class","UppyDashboardFileCard-fieldset"),_appendChild(b,[" ",(o=document.createElement("label"),o.setAttribute("class","UppyDashboardFileCard-label"),o.textContent="Name",o)," ",(u=document.createElement("input"),u.setAttribute("name","name"),u.setAttribute("type","text"),u.setAttribute("value",""+String(A.meta.name)),u.onkeyup=t,u.setAttribute("class","UppyDashboardFileCard-input"),u)," "]),b)," ",i(A)," "]),m)," "]),h):null," ",(s=document.createElement("div"),s.setAttribute("class","UppyDashboard-actions"),_appendChild(s,[" ",(d=document.createElement("button"),d.setAttribute("type","button"),d.setAttribute("title","Finish editing file"),d.onclick=function(){return e.done(F,A.id)},d.setAttribute("class","UppyButton--circular UppyButton--blue UppyDashboardFileCard-done"),_appendChild(d,[checkIcon()]),d)," "]),s)," "]),p};
...
"use strict";function isModeAvailable(e,t){return e.indexOf(t)!==-1}var _appendChild=require("yo-yoify/lib/appendChild"),_onload=require("on-load"),SnapshotButton=require("./SnapshotButton"),RecordButton=require("./RecordButton");module.exports=function(e){var t,o,n,a,i=e.src||"",r=void 0;if(e.useTheFlash)r=e.getSWFHTML();else{var d;d=document.createElement("video"),d.setAttribute("autoplay","autoplay"),d.setAttribute("src",""+String(i)),d.setAttribute("class","UppyWebcam-video"),r=d}var s=e.supportsRecording&&(isModeAvailable(e.modes,"video-only")||isModeAvailable(e.modes,"audio-only")||isModeAvailable(e.modes,"video-audio")),u=isModeAvailable(e.modes,"picture");return a=document.createElement("div"),_onload(a,function(t){e.onFocus();var o=t.querySelector(".UppyWebcam-recordButton");o&&o.focus()},function(t){e.onStop()},6),a.setAttribute("class","UppyWebcam-container"),_appendChild(a,[" ",(t=document.createElement("div"),t.setAttribute("class","UppyWebcam-videoContainer"),_appendChild(t,[" ",r," "]),t)," ",(o=document.createElement("div"),o.setAttribute("class","UppyWebcam-buttonContainer"),_appendChild(o,[" ",s?RecordButton(e):null," ",u?SnapshotButton(e):null," "]),o)," ",(n=document.createElement("canvas"),n.setAttribute("style","display: none;"),n.setAttribute("class","UppyWebcam-canvas"),n)," "]),a};
